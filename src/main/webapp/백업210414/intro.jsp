...
/>
<script
	src="${pageContext.request.contextPath}/js/swiper.js"
></script>
...
@media ( max-width :1104px) {
	...
	<div class="sub-right">
		...
		<div class="sub7_tab_menu" style="text-align: center;">
			<a href="/WebProject1/intro.jsp" class="sub7_tab check" style="display: inline-block;">소개</a> <a
				class="sub7_tab" style="display: inline-block;"
			>공지사항</a> <a href="/WebProject1/docu.jsp" class="sub7_tab" style="display: inline-block;">서식</a> <a
				class="sub7_tab" style="display: inline-block;"
			>성과</a> <a class="sub7_tab" style="display: inline-block;">과제
				계획서</a> <a class="sub7_tab" style="display: inline-block;">기업/기관 수요</a>
		</div>
...
.sub-right-title{
	...
	display: flex;
			...
			<div class="sub-div-st intro">
				<table class="sub-inner-div-st capstone table intro" cellpadding="0"
				...
				<div class="sub-inner-div-st capstone img intro" style="width: 40%">
					<img
			...
			<ul class="sub-sec-list">
				<li>학과에서 개설한 교과목 중 종합설계 또는 Capstone Design으로 표기된 교과목을 수강하는 학부생
					3인 이상으로 구성된 팀</li>
			</ul>
			<div class="sub-sec-title">
				<div class="img-sub-marker">
			...
			<div class="sub-div-st linner">
				...
				>
					...
					<tr class="sub-sec-list">
						<td></td>
						<td>기업/지역사회에서 제안한 주제에 대한 작품제작을 추진하고 기업/지역사회 전문가와 함께 작품을 지도하는
							캡스톤 디자인</td>
					</tr>
				</table>
			</div>
