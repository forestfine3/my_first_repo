...
.check {
    ...
    border-top: 3px solid #0075c2!important;
				...
				<div class="sub-right">
					...
					>소개</a> <a href="/WebProject1/notice.jsp?categoryname=공지사항" class="sub7_tab check" style="display: inline-block;">공지사항</a>
					...
					<div class="page">
						...
						<ul>
							...
							<li><a
								href="/spb3/sboard3/list.php?db=notice&amp;cateuid=23&amp;page=2"
							> 2 </a></li>
