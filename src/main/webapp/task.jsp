...
.check {
	...
	border-top: 3px solid #0075c2 !important;
				...
				<div class="sub-right">
					...
					<a href="/WebProject1/task.jsp?categoryname=과제 계획서" class="sub7_tab check" style="display: inline-block;">과제 계획서</a> <a href="/WebProject1/demand.jsp?categoryname=기업/기관 수요"
					...
					<div class="page">
						...
						<ul>
							...
							<li><a href="/spb3/sboard3/list.php?db=taskplan&amp;page=2">
									2 </a></li>

							<li><a href="/spb3/sboard3/list.php?db=taskplan&amp;page=3">
									3 </a></li>

							<li><a href="/spb3/sboard3/list.php?db=taskplan&amp;page=4">
									4 </a></li>

							<li><a href="/spb3/sboard3/list.php?db=taskplan&amp;page=5">
									5 </a></li>

						</ul>
						<div class="pageNext">
							<span class="pageRight"><a
								href="/spb3/sboard3/list.php?db=taskplan&amp;page=6"
							><span style="font-size: 11px;"><i
										class="fa fa-angle-right"
									></i></span></a></span> <span class="pageDoubleRight"><a
								href="/spb3/sboard3/list.php?db=taskplan&amp;page=7"
							><span style="font-size: 11px;"><i
